...
public class TaskExecutionSnapshot {
    ...
    private final Map<String, HashCode> inputProperties;
    ...
    public Map<String, HashCode> getInputProperties() {
